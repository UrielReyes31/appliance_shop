...
@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        ...
        <h3 class="mb-5"> Tienda de electrodomesticos GUTMANN.</h3>
    </div>
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-footer">
                    <button type="submit" href="" class="btn btn-primary btn-lg btn-block mb-3">{{ _('Iniciar sesión') }}</button>
                    <div class="pull-left">
                        <h6>
                    ...
                    <div class="pull-right">
                        <h6>
                            <a href="{{ route('password.request') }}" class="link footer-link">{{ _('Olvido la contraseña?') }}</a>
                        </h6>
                    </div>
                </div>
            </div>
